...
# Observable subscripts
p = "0"  # Outgoing (scattered) polarization
q = "0"  # Outgoing (recoil) polarization
i = "0"  # Incoming (beam) polarization
k = "0"  # Incoming (target) polarization
observable = "C_" . p . "-" . q . "-" . i . "-" . k
...
title_string =  "C_{" . p . q . i . k . "} for EKM R=0.9 fm, {/Symbol L}_b = 600 MeV, prior set A_{/Symbol e}, E = " . energy . " MeV"

# --------------------- End Set-up --------------------------------

# common label for output files: get 1,2,3,4,5 appended
out_file_base = "X0_DOB_0.68-0.95_Lambda-600_" . observable . "_vs_theta-0-181-1_energy-" . energy

# input file names with cross section and DoB bands
relative_path = "../observables_with_errors/"
observable_file = "X0_DOB_0.68-0.95_Lambda-600_" . observable . "_vs_theta-0-181-1_energy-" . energy
...
file_exp = "pwa_" . observable . "_energy-" . energy . ".dat"
...
# labels
my_x_label = '{/Symbol q} [deg]'
# my_y_label = 'diff cross section [mb/Sr]'
my_y_label = ''
